            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger text-primary" style="font-size:20px" href="index.php?page=home">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger text-primary" style="font-size:20px" href="admin/ajax.php?action=logout2"><?php echo "Welcome ". $_SESSION['login_first_name'].' '.$_SESSION['login_last_name'] ?> <i class="fa fa-power-off"></i></a></li>
                      <?php else: ?>
                        <li class="nav-item badge badge-pill badge-primary"><a class="nav-link js-scroll-trigger text-light pr-3 pt-2 pb-2" style="font-size:20px" href="javascript:void(0)" id="login_now">Login Here</a></li>
                      <?php endif; ?>
                    </ul>
                </div>
            </div>
